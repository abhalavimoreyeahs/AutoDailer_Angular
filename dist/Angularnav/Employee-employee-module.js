...
var EmployeeComponent = /** @class */ (function () {
    function EmployeeComponent(toastrService, formBuilder, service, router) {
        ...
        this.displayedColumns = ['S No', 'firstName', 'lastName', 'email', 'createdAt', 'role', 'delete']; //, 'Start Time', 'End Time'
    }
    EmployeeComponent.prototype.ngOnInit = function () {
        ...
        this.service.getAllEmployees().subscribe(function (data) {
            ...
            _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](_this.Employees);
    ...
    EmployeeComponent.prototype.deleteParticularEmployee = function (id) {
        var _this = this;
            ...
            if (result.value) {
                _this.service.deleteEmployee(id).subscribe(function (data) {
                    ...
                    if (data['success'] == true) {
                        ...
                        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire('Oops...', 'User not found!', 'error');
                        _this.ngOnInit();
                    }
                }, function (err) {
                    console.log(err);
                    sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire('Oops...', 'Something went wrong!', 'error');
                    _this.ngOnInit();
                });
                ...
                sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire('Cancelled', 'Employee is safe :)', 'error');
            }
        });
    };
