...
var ScheduledCallComponent = /** @class */ (function () {
    function ScheduledCallComponent(toastrService, formBuilder, service, router) {
        ...
        this.displayedColumns = ['S No', 'AgentId', 'Customer Mob No', 'Created At', 'Start Time', 'End Time'];
    }
