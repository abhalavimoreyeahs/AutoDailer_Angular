(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["manager-dashboard-manager-dashboard-module"],{
...
var ChartistComponent = /** @class */ (function () {
    ...
    function () {
        ...
        if (!(this.type in chartist__WEBPACK_IMPORTED_MODULE_1__)) {
            throw new Error(this.type + " is not a valid chart type");
        }
        this.chart = ((/** @type {?} */ (chartist__WEBPACK_IMPORTED_MODULE_1__)))[this.type](nativeElement, this.data, this.options, this.responsiveOptions);
        if (this.events) {
            this.bindEvents();
        }
    ...
    ChartistComponent.propDecorators = {
        ...
        initialized: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"] }]
    };
...
/***/ "./src/app/manager/manager-dashboard/manager-dashboard-routing.module.ts":
/*!*******************************************************************************!*\
  !*** ./src/app/manager/manager-dashboard/manager-dashboard-routing.module.ts ***!
  \*******************************************************************************/
/*! exports provided: ManagerDashboardRoutingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ManagerDashboardRoutingModule", function() { return ManagerDashboardRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _manager_dashboard_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./manager-dashboard.component */ "./src/app/manager/manager-dashboard/manager-dashboard.component.ts");
...
var routes = [
    {
        path: '',
        component: _manager_dashboard_component__WEBPACK_IMPORTED_MODULE_3__["ManagerDashboardComponent"]
    }
];
var ManagerDashboardRoutingModule = /** @class */ (function () {
    function ManagerDashboardRoutingModule() {
    }
    ManagerDashboardRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
        })
    ], ManagerDashboardRoutingModule);
    return ManagerDashboardRoutingModule;
}());
...
/***/ "./src/app/manager/manager-dashboard/manager-dashboard.component.css":
/*!***************************************************************************!*\
  !*** ./src/app/manager/manager-dashboard/manager-dashboard.component.css ***!
  \***************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21hbmFnZXIvbWFuYWdlci1kYXNoYm9hcmQvbWFuYWdlci1kYXNoYm9hcmQuY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/manager/manager-dashboard/manager-dashboard.component.html":
/*!****************************************************************************!*\
  !*** ./src/app/manager/manager-dashboard/manager-dashboard.component.html ***!
  \****************************************************************************/
/*! no static exports found */
...
var ManagerDashboardComponent = /** @class */ (function () {
    function ManagerDashboardComponent(toastrService, formBuilder, service, managerService) {
        ...
        this.BarChart = [];
        this.stackedBar = [];
        this.CallToday = [0, 0, 0, 0, 0];
        // CallDetails
        this.agentActiveOnCall = 0;
        this.agentWatitingForCall = 0;
        this.successfullCall = 0;
        this.callFailed = 0;
        this.noAnswer = 0;
        this.TodayScheduledCall = 0;
        this.callAttended = 0;
        ...
        this.CallInfoType = [0, 0, 0, 0, 0, 0, 0, 0, 0];
        this.callApi();
    }
    ...
    ManagerDashboardComponent.prototype.callApi = function () {
        ...
        this.managerService.getCallInfo().subscribe(function (data) {
            console.log(data);
            if (data['success'] == true) {
                _this.CallInfoType[0] = data['message']['Dealdone'],
                    _this.CallInfoType[1] = data['message']['Introductioncalls'],
                    _this.CallInfoType[2] = data['message']['Followupcalls'],
                    _this.CallInfoType[3] = data['message']['Callback'],
                    _this.CallInfoType[4] = data['message']['Voicemail'],
                    _this.CallInfoType[5] = data['message']['Blacklist'],
                    _this.CallInfoType[6] = data['message']['Numberdoesnotmatch'],
                    _this.CallInfoType[7] = data['message']['Underage'],
                    _this.CallInfoType[8] = data['message']['Duplicate'];
                _this.ngOnInit();
            }
        });
        this.managerService.getCallDetailsForBadges().subscribe(function (data) {
            console.log(data);
            if (data['success'] == true) {
                if (data['message']) {
                    _this.agentActiveOnCall = data['message']['agentActiveOnCall'];
                    _this.agentWatitingForCall = data['message']['agentWatitingForCall'];
                    _this.CallToday[0] = _this.successfullCall = data['message']['successfullCall'];
                    _this.CallToday[2] = _this.callFailed = data['message']['callFailed'];
                    ;
    ...
    //notification
    ManagerDashboardComponent.prototype.showToaster = function () {
        this.toastrService.success('Data Saved Successfully');
    };
    ManagerDashboardComponent.prototype.ErrorSuccess = function () {
        this.toastrService.error('Failed to save Data');
    };
    ManagerDashboardComponent.prototype.infoSuccess = function () {
        this.toastrService.info('info msg', 'Info!');
    };
    ManagerDashboardComponent.prototype.warningSuccess = function () {
...
/*!***********************************************************************!*\
  !*** ./src/app/manager/manager-dashboard/manager-dashboard.module.ts ***!
  \***********************************************************************/
/*! exports provided: ManagerDashboardModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ManagerDashboardModule", function() { return ManagerDashboardModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var ng_chartist__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ng-chartist */ "./node_modules/ng-chartist/fesm5/ng-chartist.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _manager_dashboard_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./manager-dashboard-routing.module */ "./src/app/manager/manager-dashboard/manager-dashboard-routing.module.ts");
/* harmony import */ var _manager_dashboard_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./manager-dashboard.component */ "./src/app/manager/manager-dashboard/manager-dashboard.component.ts");
...
var ManagerDashboardModule = /** @class */ (function () {
    function ManagerDashboardModule() {
    }
    ManagerDashboardModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _manager_dashboard_routing_module__WEBPACK_IMPORTED_MODULE_4__["ManagerDashboardRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _material_material_module__WEBPACK_IMPORTED_MODULE_7__["MaterialModule"], ng_chartist__WEBPACK_IMPORTED_MODULE_2__["ChartistModule"]],
            declarations: [_manager_dashboard_component__WEBPACK_IMPORTED_MODULE_5__["ManagerDashboardComponent"]]
        })
    ], ManagerDashboardModule);
    return ManagerDashboardModule;
}());
...
//# sourceMappingURL=manager-dashboard-manager-dashboard-module.js.map